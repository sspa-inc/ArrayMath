...
public :: mrgref
private :: kdp
private :: R_mrgref, I_mrgref, D_mrgref, C_mrgref
interface mrgref
  module procedure d_mrgref, r_mrgref, i_mrgref, c_mrgref
end interface mrgref
contains

Subroutine C_mrgref (XVALT, IRNGT)
...
! __________________________________________________________
! __________________________________________________________
      character (len=*), Dimension (:), Intent (In) :: XVALT
